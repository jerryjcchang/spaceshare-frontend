  ...
  render() {
    return (
      ...
      <Card
        ...
        fluid
        as={Link}
        to={`/spaces/${this.props.booking.space.id}`}
      >
        <div className="rate-div">
          <h3>{this.props.booking.space.name}</h3>
        </div>
        <Image id="card-img" src={this.props.booking.space.img_url} />
        <Card.Content>
          ...
          <Card.Description>
            <Header>
              <Icon
                ...
                name="calendar check"
              />
              Booked Days: {this.props.booking.dates.length}
            </Header>
          </Card.Description>
        </Card.Content>
      </Card>
